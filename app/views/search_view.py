def render_page(data):
    html_template = """
        ...
        <body>
            <div class="search-container">
                ...
                <form id="search-form" action="/search/duckduckgo-web">
                    <div class="search-links">
                        <span class="search-link" data-url="/search/bing-web">Bing</span>
                        <span class="search-link" data-url="/search/baidu-web">Baidu</span>
                        <span class="search-link" data-url="/search/duckduckgo-web">DuckDuckGo</span>
                        <span class="search-link" data-url="/search/google-web">Google</span>
                        <span class="search-link" data-url="/search/sogou-web">Sogou</span>
                        <span class="search-link" data-url="/search/so-web">360</span>
                    </div>
                    <input type="text" id="search-query" name="q" class="search-input" value="贵州茅台600519 东方财富 同花顺 新浪财经 雪球财经" placeholder="请输入关键词：狂飙 电视剧 百科 豆瓣"><button type="submit" class="search-button">搜索</button>
            ...
            <div class="results-container"><code id="search-results">这是根据节目名称和频道等关键词从搜索引擎获取结果，再抓取豆瓣和百科词条的工具。有多种搜索引擎和抓取工具组合，提高抓取成功率。</code></div>
            ...
            <script>
                ...
                async function handleSubmit(event) {{
                    ...
                    const query = $searchForm.querySelector('#search-query').value;
